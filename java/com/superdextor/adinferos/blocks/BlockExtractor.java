...
public class BlockExtractor extends BlockContainer
{
    		...
    		EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) 
    {
        ...
        {
            playerIn.openGui(ThinkBigCore.modInstance, AdInferosGuis.extractor.ID, worldIn, pos.getX(), pos.getY(), pos.getZ());
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
    	...
    	if (tileentity instanceof TileEntityExtractor)
    	{
    		TileEntityExtractor extractor = (TileEntityExtractor) tileentity;

...
public class ModelNetherSkeleton extends ModelBiped
{
    ...
    public ModelNetherSkeleton(float modelSize, boolean p_i46303_2_)
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        if (((EntityNetherSkeleton)entitylivingbaseIn).IsUsingRange())
        {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (((EntityNetherSkeleton)entityIn).IsUsingRange())
        {

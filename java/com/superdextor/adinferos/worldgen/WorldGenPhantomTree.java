...
public class WorldGenPhantomTree extends WorldGenAbstractTree implements IOverridable
{
    private static final IBlockState log = NetherBlocks.LOG.getDefaultState().withProperty(BlockNetherPlanks.VARIANT, BlockNetherPlanks.EnumType.PHANTOM);
    private static final IBlockState leaves = NetherBlocks.LEAVES.getDefaultState().withProperty(BlockNetherPlanks.VARIANT, BlockNetherPlanks.EnumType.PHANTOM).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
